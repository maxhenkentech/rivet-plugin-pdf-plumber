// src/nodes/PDFPlumberNode.ts
function PDFPlumberNode_default(rivet) {
  const nodeImpl = {
    ...
    getUIData() {
      return {
        ...
        group: "Example",
        infoBoxBody: "Extract text from a PDF using pdfplumber.",
    ...
    async process(data, inputData, context) {
      ...
      const { pdfplumber } = await import("../dist/nodeEntry.cjs");
...
var initializer = (rivet) => {
  const node = PDFPlumberNode_default(rivet);
  const plugin = {
